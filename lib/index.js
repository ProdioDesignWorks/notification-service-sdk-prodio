...
var _restConfig = require('./restConfig');
...
var notificationModule = function () {
  ...
  _createClass(notificationModule, [{
    ...
    value: function createNotificationConsumer(payload) {
      var hasConfigured = this.checkConfig();
      if (!hasConfigured) {
    ...
    value: function createUser(payload) {
      ...
      this.createNotificationConsumer(payload).then(function (userResponse) {
